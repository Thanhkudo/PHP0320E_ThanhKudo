...
if (isset($_POST['submit'])){
    ...
    if (empty($error)){
        $update= $conn->prepare("UPDATE `employees` SET `name` = :name, `description` = :des, `gender` = :gender, `salary` = :salary, `birthday` = :date WHERE id=$id");
        $arr_update=[
           ':name'=>$name,
            ':des'=>$des,
            ':gender'=>$gender,
        ...
        $is_update=$update->execute($arr_update);
        if ($is_update){
...
<div class="container col-4">
    <div class="form-group">
        <form action="" method="post">
            ...
            <input type="text" name="name" id="name" class="form-control" value="<?php echo $is_select['name']?>">
            <label for="name">Description </label>
            <input type="text" name="des" id="des" class="form-control" value="<?php echo $is_select['description']?>">
            <label for="name">Salary </label>
            <input type="text" name="salary" id="salary" class="form-control" value="<?php echo $is_select['salary']." VNĐ"?>">
            ...
            <input type="date" name="date" id="date" class="form-control" value="<?php echo $is_select['birthday']?>"><br>
